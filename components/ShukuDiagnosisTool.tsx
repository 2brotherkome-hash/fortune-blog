...
const SHUKU_LIST = [
  { name: "昴", read: "ぼうしゅく", catch: "華やかな存在感と強い意志を持つ星" },
  { name: "畢", read: "ひっしゅく", catch: "堅実な努力で夢をつかむ勤勉の星" },
  { name: "觜", read: "ししゅく", catch: "鋭い知性と表現力を持つ言葉の星" },
  { name: "参", read: "しんしゅく", catch: "強さと優しさを兼ね備えた守護の星" },
  { name: "井", read: "せいしゅく", catch: "豊かな発想力と社交性を持つ繁栄の星" },
  { name: "鬼", read: "きしゅく", catch: "深い洞察力と変革の力を持つ星" },
  { name: "柳", read: "りゅうしゅく", catch: "しなやかな適応力と感受性の星" },
  { name: "星", read: "せいしゅく", catch: "輝きと個性で人を惹きつける星" },
  { name: "張", read: "ちょうしゅく", catch: "広い視野と包容力を持つ大器の星" },
  { name: "翼", read: "よくしゅく", catch: "自由を愛し高みを目指す飛翔の星" },
  { name: "軫", read: "しんしゅく", catch: "深い思慮と誠実さを持つ信頼の星" },
  { name: "角", read: "かくしゅく", catch: "先見の明と正義感あふれるリーダーの星" },
  { name: "亢", read: "こうしゅく", catch: "真実を追い求める探求者の星" },
  { name: "氐", read: "ていしゅく", catch: "穏やかな安定感と深い愛情の星" },
  { name: "房", read: "ぼうしゅく", catch: "温かい人間関係と繁栄をもたらす星" },
  { name: "心", read: "しんしゅく", catch: "情熱と直感力で運命を切り拓く星" },
  { name: "尾", read: "びしゅく", catch: "粘り強さと再生の力を持つ不死鳥の星" },
  { name: "箕", read: "きしゅく", catch: "豊かな収穫と実りをもたらす星" },
  { name: "斗", read: "としゅく", catch: "着実に目標へ進む意志の星" },
  { name: "牛", read: "ぎゅうしゅく", catch: "勤勉と忍耐で大きな富を築く星" },
  { name: "女", read: "じょしゅく", catch: "柔軟な知恵と人を包む温かさの星" },
  { name: "虚", read: "きょしゅく", catch: "無限の可能性を秘めた変化の星" },
  { name: "危", read: "きしゅく", catch: "変化を恐れず前進する勇気の星" },
  { name: "室", read: "しつしゅく", catch: "深い精神性と守護の力を持つ星" },
  { name: "壁", read: "へきしゅく", catch: "知識と学びで人生を豊かにする星" },
  { name: "奎", read: "けいしゅく", catch: "創造力と文才に恵まれた芸術の星" },
  { name: "婁", read: "ろうしゅく", catch: "人を集め縁をつなぐ絆の星" },
];

function getShuku(month: number, day: number) {
  const ref = new Date(2000, 0, 1); // Jan 1, 2000
